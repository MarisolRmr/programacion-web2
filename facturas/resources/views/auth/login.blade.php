...
@section('contenido')
    ...
    <div class="md:flex md:justify-center md:gap-8 md:items-center ">
        <div class="md:w-5/12 p-5">
            <img src="{{ asset('img/login_2.png') }}" alt="Imagen login de usuarios" >
        </div>
        ...
        <div class="md:w-6/12 bg-white p-6 rounded-lg shadow-xl">
            <form method="POST" action="{{ route('login') }}" novalidate>
                ...
                <div class="flex justify-center">
                    <button type="submit" class="bg-indigo-500 text-white px-6 py-3 rounded-md font-bold">Iniciar sesión</button>
                  </div>
