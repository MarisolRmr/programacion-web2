        ...
        <div class="flex-auto p-6">
          <div class="flex flex-wrap -mx-3">
            <div class="w-full max-w-full px-3 shrink-0 md:w-6/12 md:flex-0">
              <div class="mb-4">
                <label for="nombre" class="inline-block mb-2 ml-1 font-bold text-xs text-slate-700 dark:text-white/80">Nombre</label>
                <input 
                type="text" 
                id="nombre" 
                name="nombre" 
            ...
            <div class="w-full max-w-full px-3 shrink-0 md:w-6/12 md:flex-0">
              <div class="mb-4">
                <label for="direccion" class="inline-block mb-2 ml-1 font-bold text-xs text-slate-700 dark:text-white/80">Dirección</label>
                <input 
                type="text" 
                id="direccion" 
                name="direccion" 
            ...
            <div class="w-full max-w-full px-3 shrink-0 md:w-6/12 md:flex-0">
              <div class="mb-4">
                <label for="rfc" class="inline-block mb-2 ml-1 font-bold text-xs text-slate-700 dark:text-white/80">RFC</label>
                <input 
                type="text" 
                id="rfc" 
                name="rfc" 
